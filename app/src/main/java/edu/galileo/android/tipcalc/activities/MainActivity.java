...
public class MainActivity extends AppCompatActivity {
    ...
    @Bind(R.id.btnSubmit)
    Button btnSubmit;
    @Bind(R.id.inputPercetage)
    EditText inputPercetage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Permite que los valores no se reinicie cuando ocurra un evento.
    ...
    private void handleTipChange(int change){
        ...
        if (tipPercentage > 0){
            inputPercetage.setText(String.valueOf(tipPercentage));
        }
    ...
    public int getTipPercentage() {
        ...
        String strInputTipPercentage = inputPercetage.getText().toString().trim();
